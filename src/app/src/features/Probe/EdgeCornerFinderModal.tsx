        ...
        if (probeMode === 'inside') {
            ...
            if (isSingleEdge) {
                ...
                gcodeLines.push(
                    ...
                    rapidCmd(`X${-xDir * effectiveRetract}`),
                    ...
                    rapidCmd(`Y${-yDir * effectiveRetract}`),
            ...
            if (isSingleEdge) {
                ...
                if (probeZ) {
                    gcodeLines.push(
                        ...
                        rapidCmd(`X${-xDir * 12}`),
                        rapidCmd('Z-[Z_LIFT_TOTAL - Z_UNDER_SURFACE]'),
                        `G38.2 X${xDir * 35} F[PROBE_FEED_FAST]`,
                        rapidCmd(`X${-xDir * effectiveRetract}`),
                        `G38.2 X${xDir * 5} F[PROBE_FEED_SLOW]`,
                        rapidCmd(`X${-xDir * effectiveRetract}`),
                        'G4 P1',
                        `G10 L20 P0 X${-xDir * (effectiveRetract + effectiveTipRad)}`,
                        '',
                        '; --- SMOOTH SWEEP AROUND CORNER IN OPEN AIR (AT DEPTH) ---',
                        rapidCmd(`Y${-yDir * 15}`),
                        rapidCmd(`X${xDir * 15}`),
                        '',
                        '; --- PROBE CORNER 2ND EDGE (Y) ---',
                        `G38.2 Y${yDir * 35} F[PROBE_FEED_FAST]`,
                        rapidCmd(`Y${-yDir * effectiveRetract}`),
                        `G38.2 Y${yDir * 5} F[PROBE_FEED_SLOW]`,
                        rapidCmd(`Y${-yDir * effectiveRetract}`),
                        'G4 P1',
